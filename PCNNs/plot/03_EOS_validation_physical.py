...
data = pd.DataFrame(pd.read_csv(r"D:\03_LSP\06_github\03_rf_geemapResult\03_rf_geemapResult\06_EOS_validation_result_physical.csv"))
print(data)
...
plt.savefig(r'D:\03_LSP\06_github\03_rf_geemapResult\01_result\03_EOS_validation_physical.png', dpi=300)
