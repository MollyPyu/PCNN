...
data = pd.DataFrame(pd.read_csv(r"D:\03_LSP\06_github\03_rf_geemapResult\03_rf_geemapResult\03_validation_result_phesical.csv"))
print(data)
...
plt.savefig(r'D:\03_LSP\06_github\03_rf_geemapResult\01_result\03_SOS_validation_physical.png', dpi=300)
