...
data = pd.DataFrame(pd.read_csv(r"D:\03_LSP\06_github\03_rf_geemapResult\03_rf_geemapResult\03_SOS_validation_result.csv"))
print(data)
...
plt.savefig(r'D:\03_LSP\06_github\03_rf_geemapResult\01_result\03_SOS_validation2.png', dpi=300)
